const bio = "Biotech. Web tech. Observations. Runner.";

module.exports = {
  title: "Blog by Juro Oravec",
  subtitle: bio,
  author: {
    name: "Juro Oravec",
    photo: "/photo.jpg",
